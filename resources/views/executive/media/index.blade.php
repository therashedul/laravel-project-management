...
@section('content')
            ...
            <div class="card">
                <div class="card-header">Media
                    <span class="float-right">
                        {{-- <a class="btn btn-primary" href="{{ route('executive.media.create') }}">Create New</a> --}}
                    ...
                    <div id="third" style=" display: none;">
                        <div class="jumbotron">
                            ...
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="{{ route('executive.media.upload') }}">
                                @csrf
                    ...
                    @foreach ($data as $key => $imagefile)
                        ...
                        <script type="text/javascript">
                            function myFunction_{{ $imagefile->id }}() {
                                ...
                                $.ajax({
                                    url: "{{ route('executive.media.delete') }}",
                                    data: ({
                                        name: file_name,
                                        id: file_id
                                    }),
    ...
    <script type="text/javascript">
        ...
        $(document).on('input', '#input_search_image_file', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('executive.media.search') }}",
                data: data,
