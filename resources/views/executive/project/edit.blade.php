...
@section('content')
    ...
    <div class="container">
        ...
        <div class="justify-content-center">
            ...
            <div class="card">
                <div class="card-header">Edit Project
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('executive.projects') }}">Project</a>
                    </span>
                </div>
                <div class="card-body">
                    {!! Form::model($editproject, ['route' => ['executive.projects.update', $editproject->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}
                    ...
                    <div class="col-md-8" id="NewClass">
                        <div class="form-group">
                            ...
                            <div id="post_select_image_container" class="post-select-image-container">
                                @if ($editproject->project_logo != null)
                                    <button class="pull-right mt-4" onclick="displayimageRemove()" id="btn_delete">
                                        <i class="fa fa-times"></i>
                                    </button>
                                @endif
                                <img src="{{ asset('images/' . $editproject->project_logo) }}" id="selected_image_file"
                                    alt="">
                            </div>
                            <input type="hidden" name="upload_id" value="{{ $editproject->image_id }}">
                            <input type="hidden" name="image_id" id="image_id" value="{{ $editproject->image_id }}">
                            <input type="hidden" name="image_name" id="image_name"
                                value="{{ $editproject->project_logo }}">
                            <input type="hidden" name="alt" id="alt_value" value="{{ $editproject->alt }}">
                            <input type="hidden" name="title" id="title_value" value="{{ $editproject->title }}">
                            <input type="hidden" name="caption" id="caption_value" value="{{ $editproject->caption }}">
                    ...
                    <div class="col-md-4">
                        ...
                        @else
                            <div id="rightHide">
                                ...
                                <div class="form-group">
                                    <label>Alt</label>
                                    <input class="form-control" type="text" name="alt" value="{{ $editproject->alt }}">
                                </div>
                                <div class="form-group">
                                    <label>Title</label>
                                    <input class="form-control" type="text" name="title"
    ...
    <div class="modal fade" id="image_file_manager">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                {{-- {!! Form::open(['method' => 'get', 'route' => 'executive.projects.destroy', 'enctype' => 'multipart/form-data', 'id' => 'myform']) !!} --}}
                <div class="modal-body">
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="{{ route('executive.projects.upload') }}">
                                @csrf
    ...
    <script type="text/javascript">
        ...
        function load_images() {
            $.ajax({
                url: "{{ route('executive.projects.fetch') }}",
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#image_file_manager #btn_img_delete', function() {
            ...
            $.ajax({
                url: "{{ route('executive.projects.delete') }}",
                data: {
                    name: file_name
                },
                success: function(data) {
        ...
        $(document).on('input', '#input_search_image', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('executive.projects.search') }}",
                data: data,
