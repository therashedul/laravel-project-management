...
@section('content')
            ...
            <div class="card">
                <div class="card-header">Edit Document
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('executive.documents') }}">Document</a>
                    </span>
                </div>
                <div class="card-body">

                    {!! Form::model($editdocument, ['route' => ['executive.documents.update', $editdocument->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}
    ...
    <div class="modal fade" id="image_file_manager">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                {{-- {!! Form::open(['method' => 'get', 'route' => 'executive.documents.destroy', 'enctype' => 'multipart/form-data', 'id' => 'myform']) !!} --}}
                <div class="modal-body">
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" class="dropzone" enctype="multipart/form-data"
                                action="{{ route('executive.documents.upload') }}">
                                @csrf
    ...
    <script type="text/javascript">
        ...
        function load_images() {
            $.ajax({
                url: "{{ route('executive.documents.fetch') }}",
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#image_file_manager #btn_img_delete', function() {
            ...
            $.ajax({
                url: "{{ route('executive.documents.delete') }}",
                data: {
                    name: file_name,
                    imageId: file_id
                },
        ...
        $(document).on('input', '#input_search_image', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('executive.documents.search') }}",
                data: data,
