...
@section('content')
                                                        ...
                                                        @if ($role->id == Auth::user()->role_id && $role->id == $rhp->role_id)
                                                            @if ($rhp->permission_id == $permission->id)
                                                                ...
                                                                @if (stristr($name, 'document'))
                                                                    ...
                                                                    href="{{ route('executive.documents.show', $document->id) }}">Show</a> --}}
                                                                    @elseif ($value == 'create')
                                                                        {{-- <a class="btn btn-primary"
                                                                        href="{{ route('executive.documents.create') }}">New
                                                                        document</a> --}}
                                                                    @elseif ($value == 'edit')
                                                                        @if ($document->document_image_id == null)
                                                                            <a class="btn btn-primary btn-sm"
                                                                                onclick="Warn()"
                                                                                href="{{ route('executive.documents.edit', $document->id) }}"><i
                                                                        ...
                                                                        @endif
                                                                    @elseif ($value == 'delete')
                                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['executive.documents.destroy', $document->id], 'style' => 'display:inline']) !!}
    ...
    <script type="text/javascript">
        ...
        $(document).on('input', '#input_search_image_file', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('executive.documents.filesearch') }}",
                data: data,
