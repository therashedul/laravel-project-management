                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="bg-primary text-white text-center d-block">
                                                {{ date('d-m-Y', strtotime($task->start_date)) }}</p>
                                        </td>
                                        <td>
                                            <p class="bg-info text-white text-center d-block">
                                                {{ date('d-m-Y', strtotime($task->end_date)) }}</p>
                                        </td>
                                        <td>
                                            <style>
                                                :root {
                                        ...
                                        <td class="text-center">
                                                                ...
                                                                @if (stristr($name, 'task'))
                                                                    ...
                                                                    @elseif ($value == 'show')
                                                                        <a class="btn btn-info btn-sm"
                                                                            href="{{ route('admin.tasks.show', $task->id) }}"><i
                                                                                class="fas fa-eye"></i></a>
                                                                    @elseif ($value == 'edit')
                                                                        @if ($task->task_image_id == null)
                                            ...
                                            @if (Auth::user()->name == 'admin')
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.tasks.destroy', $task->id], 'style' => 'display:inline']) !!} {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!} {!! Form::close() !!}
                                            @endif --}}
                                        </td>
                                    </tr>
                                @endforeach
