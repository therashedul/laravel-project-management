            ...
            <div class="card">
                <div class="card-header">Show Task
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('admin.tasks') }}">Task</a>
                    </span>
                </div>
                <div class="card-body">
                    {{-- {{ $task }} --}}
                    {!! Form::model($task, ['route' => ['admin.tasks.update', $task->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}
