            ...
            <div class="card">
                <div class="card-header">Create Task
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('admin.documents') }}">Task</a>
                    </span>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        ]) !!} {{-- {1,15} this text lenth --}}

                    </div>
                    <div class="form-group">
                        <strong>Description:</strong>
                        {!! Form::textarea('task_description', null, [
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('task_progress', null, [
                            'placeholder' => 'Type number out of 100',
                            'class' => 'form-control',
                            'min' => '0',
                            'max' => '100',
                            'required',
