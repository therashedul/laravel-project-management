            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <strong>Title:</strong>
                        {!! Form::text('task_title', null, ['placeholder' => 'title', 'class' => 'form-control']) !!}
                    </div>
                    <div class="form-group">
                        <strong>Description:</strong>
                        {!! Form::textarea('task_description', null, ['placeholder' => 'Description', 'class' => 'form-control']) !!}
                    </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($users as $user)
                            ...
                            <input type="hidden" name="assign_id[]" value="{{ $user->name }}" checked>
                    ...
                    <div class="form-group">
                        <div id="datetime-panel">
                            <div class="input-group input-daterange">
                                {!! Form::text('start_date', null, ['placeholder' => 'Type Name', 'class' => 'form-control text-left mr-2']) !!}
                                <strong class="ml-3 form-control-placeholder" id="start-p" for="start">Start
                                    Date</strong>
                                <span class="fa fa-calendar" id="fa-1"></span>
                                {!! Form::text('end_date', null, ['placeholder' => 'Type Name', 'class' => 'form-control text-left mr-2']) !!}
