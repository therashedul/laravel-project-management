    ...
    <div class="container">
        ...
        <div class="justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($editproject, ['route' => ['admin.projects.update', $editproject->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}
                    ...
                    <div class="col-md-8" id="NewClass">
                        <div class="form-group">
                            ...
                            @if (!empty($editproject->project_logo))
                                <div id="post_select_image_container" class="post-select-image-container">
                                    ...
                                    @endif
                                    <img src="{{ asset('images/' . $editproject->project_logo) }}"
                                        id="selected_image_file" alt="">
                                </div>
                            @else
                                <div id="post_select_image_container" class="post-select-image-container">
                                    <img src="{{ asset('images/profile/cemera.jpg') }}" width="170px" height="200px"
                                        alt="" title="">
                                </div>
                            @endif
    ...
    <div class="modal fade" id="image_file_manager">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                {{-- {!! Form::open(['method' => 'get', 'route' => 'admin.projects.destroy', 'enctype' => 'multipart/form-data', 'id' => 'myform']) !!} --}}
                <div class="modal-body">
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="{{ route('admin.projects.upload') }}">
                                @csrf
