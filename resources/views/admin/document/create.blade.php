...
@section('content')
    ...
    <style>
        ...
        div#post_select_image_container img {
            padding-bottom: 20px;
        }
    ...
    <div class="container">
        <div class="justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'admin.documents.store', 'method' => 'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div id="post_select_image_container" class="post-select-image-container">
                            <img src="{{ asset('images/profile/file.png') }}" width="170px" height="200px" alt=""
                                title="">
                        </div>
