                    ...
                    <div class="form-group">
                        ...
                        @foreach ($users as $user)
                            ...
                            <input type="checkbox" name="assign_by[]" value="{{ $user->name }}" {{ $checked }}
                                readonly tabindex=-1>
                            <input type="hidden" name="assign_id[]" value="{{ $user->name }}" checked readonly disabled>
                            <span style="font-size: 1vw;">&nbsp;{{ $user->name }} &nbsp;</span>
                        @endforeach
                    </div>
                    <div class="form-group">
                        <strong>Progeress:</strong>
                        {!! Form::number('task_progress', null, ['placeholder' => 'Type number out of 100', 'class' => 'form-control', 'min' => '0', 'max' => '100']) !!}
                    </div>
                    <div class="form-group">
                        ...
                        <select name="task_status" class="form-control">
                            ...
                            <option value="2" {{ $task->task_status == 2 ? 'selected' : '' }}>Running </option>
