...
@section('content')
    ...
    <div class="container">
        ...
        <div class="justify-content-center">
            ...
            @endif
            <div class="card">
                <div class="card-header">Show Task
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('developer.tasks') }}">Task</a>
                    </span>
                </div>
                <div class="card-body">
                    {{-- {{ $task }} --}}
                    {!! Form::model($task, ['route' => ['developer.tasks.update', $task->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}

                    <input type="hidden" name="id" value="{{ $task->id }}">
                    <div class="form-group">

                        <strong style="font-size:1.2rem">Title:</strong>
                        {!! Form::text('task_title', null, ['placeholder' => 'title', 'class' => 'form-control', 'readonly' => 'true']) !!}
                    </div>
                    <div class="form-group">
                        <strong style="font-size:1.2rem">Description:</strong>

                        {!! Form::textarea('task_description', null, ['placeholder' => 'Description', 'class' => 'form-control', 'readonly' => 'true']) !!}
                    </div>
                    <div class="form-group">
                        ...
                        @foreach ($users as $user)
                            ...
                            <input type="checkbox" name="assign_by[]" value="{{ $user->name }}" {{ $checked }}
                                readonly tabindex=-1>

                            <span style="font-size: 1vw;">&nbsp;{{ $user->name }} &nbsp;</span>
                        @endforeach
                    </div>
                    <div class="form-group">
                        <strong style="font-size:1.2rem">Progeress:</strong>
                        <style>
                            :root {
                                --bg: #04AA6D;
                                --padding: 1;
                        ...
                        <div id="myProgress">
                            <div id="myBar" class="progress-line" style='--number:{{ $task->task_progress }};'>
                    ...
                    <div class="form-group">
                        <div id="datetime-panel">
                            <div class="input-group input-daterange">
                                {!! Form::text('start_date', null, ['placeholder' => 'Type Name', 'class' => 'form-control text-left mr-2', 'readonly' => 'true']) !!}
                                <strong style="font-size:1rem" class="ml-3 form-control-placeholder" id="start-p"
                                    for="start">Start
                                    Date</strong>
                                <span class="fa fa-calendar" id="fa-1"></span>
                                {!! Form::text('end_date', null, ['placeholder' => 'Type Name', 'class' => 'form-control text-left mr-2', 'readonly' => 'true']) !!}

                                <strong style="font-size:1rem" class="ml-3 form-control-placeholder" id="end-p"
                                    for="end">End Date</strong>
                    ...
                    <div class="form-group">
                        <strong style="font-size:1.2rem">Project Name:</strong>
