    ...
    <div class="container">
        <div class="justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'developer.projects.store', 'method' => 'POST']) !!}
                    <div class="form-group">
                        <strong>Name:</strong>
                        {!! Form::text('project_name', null, ['placeholder' => 'Name', 'class' => 'form-control', 'required']) !!}
                    </div>
                    <div class="form-group">
                        <strong>Image:</strong>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="file-manager">
                        ...
                        <div class="file-manager-right">
                            ...
                            <div class="form-group">
                                <label>URL</label>
                                <input class="form-control" readonly type="text" name="link" id="selected_img_file_path">
                            </div>
                            <div class="form-group">
                                <label>Alt</label>
                ...
                <div class="modal-footer">
                    <div class="file-manager-footer">
                        {{-- <form action="{{ route('developer.projects.delete') }}">
