...
@section('content')
            ...
            <div class="card">
                <div class="card-header">Edit Project
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('developer.projects') }}">Project</a>
                    </span>
                </div>
                <div class="card-body">
                    {!! Form::model($editproject, ['route' => ['developer.projects.update', $editproject->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'upload']) !!}
    ...
    <div class="modal fade" id="image_file_manager">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                {{-- {!! Form::open(['method' => 'get', 'route' => 'developer.projects.destroy', 'enctype' => 'multipart/form-data', 'id' => 'myform']) !!} --}}
                <div class="modal-body">
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="{{ route('developer.projects.upload') }}">
                                @csrf
    ...
    <script type="text/javascript">
        ...
        function load_images() {
            $.ajax({
                url: "{{ route('developer.projects.fetch') }}",
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#image_file_manager #btn_img_delete', function() {
            ...
            $.ajax({
                url: "{{ route('developer.projects.delete') }}",
                data: {
                    name: file_name
                },
                success: function(data) {
        ...
        $(document).on('input', '#input_search_image', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('developer.projects.search') }}",
                data: data,
