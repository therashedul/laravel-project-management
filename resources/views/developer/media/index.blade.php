...
@section('content')
            ...
            <div class="card">
                <div class="card-header">Media
                    <span class="float-right">
                        {{-- <a class="btn btn-primary" href="{{ route('developer.media.create') }}">Create New</a> --}}
                        <button id="toggle" class="btn btn-success btn-sm">Add Image/file </button>
                        <button id="search_toggle" class="btn btn-primary btn-sm">Search </button>
                    </span>
                </div>
                    ...
                    <div id="third" style=" display: none;">
                        <div class="jumbotron">
                            ...
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="{{ route('developer.media.upload') }}">
                                @csrf
                    ...
                    @foreach ($data as $key => $imagefile)
                        ...
                        <script type="text/javascript">
                            function myFunction_{{ $imagefile->id }}() {
                                ...
                                $.ajax({
                                    url: "{{ route('developer.media.delete') }}",
                                    data: ({
                                        name: file_name,
                                        id: file_id
                                    }),
    ...
    <script type="text/javascript">
        ...
        $(document).on('input', '#input_search_image_file', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('developer.media.search') }}",
                data: data,
