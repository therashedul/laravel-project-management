...
@section('content')
    ...
    <div class="container">
        <div class="justify-content-center">
            ...
            @endif
            <div class="card">
                <div class="card-header">Create Document
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'developer.documents.store', 'method' => 'POST']) !!}
                    <div class="form-group">
                        <strong>Document Name:</strong>
                        {!! Form::text('document_title', null, ['placeholder' => 'title', 'class' => 'form-control', 'required']) !!}
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="file-manager-search text-center pull-right">
                        <input type="text" id="input_search_image" placeholder="Search Document" name="search"
                            class="form-control">
                    </div>
